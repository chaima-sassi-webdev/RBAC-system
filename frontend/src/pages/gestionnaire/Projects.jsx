...
function Projects() {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:5000/api/users/clients")
  ...
  const handleUpdateProject = async (e) => {
    ...
    try {
      await axios.put(
        `http://localhost:5000/api/users/projects/${editProject._id}`,
        projectForm
      );
              ...
              <tr key={project._id}>
                ...
                <td>
                  {project.assignedEmployees?.map((emp) => (
                    <span key={emp._id} style={{ marginRight: "6px" }}>
                      {emp.name}
                    </span>
                  ))}
                </td>
                    ...
                    <button
                      ...
                      onClick={() => {
                        ...
                        setProjectForm({
                          ...
                          assignedEmployees:
                            project.assignedEmployees?.map(emp => emp._id) || [],
