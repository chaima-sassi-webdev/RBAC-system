...
function User() {
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      ...
      await axios.put(
        `http://localhost:5000/api/users/admin/user/${editingUser._id}`,
        formData
      );
...
const toggleStatus = async (userId) => {
  await axios.put(`http://localhost:5000/api/users/admin/${userId}/status`);
  fetchUsers();
};
  // ===== CREATE USER =====
              ...
              <tr key={user._id}>
                ...
                <td>
                  <div className={Styles.actions}>
                        {/* TOGGLE STATUS */}
                   <button onClick={() => toggleUserStatus(user._id)} className={Styles.toogleButton}> 
